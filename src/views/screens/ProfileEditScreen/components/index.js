...
import CustomActivityIndicator from '../../../Helper/CustomActivityIndicator';
import colors from '../../../Helper/colors'

import DropDownIcon from '../../../Helper/DropDownIcon.svg'
        ...
        return (
            <View style={{ flexDirection: 'row', padding: 20 }}>
                ...
                <View style={{ flex: 1, alignItems: 'center', flexDirection: 'column', }}>
                    <Text style={{ fontSize: 24, fontWeight: '400', color: '#FC6262', paddingTop: 3, }}>PROFILE</Text>
                    <Text style={{ fontSize: 24, fontWeight: '400', color: '#FC6262', paddingTop: 3, }}>EDIT</Text>
